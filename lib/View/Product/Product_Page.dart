...
class _ProductScreenState extends State<ProductScreen> {
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("No crops found", style: GoogleFonts.poppins(fontSize: w * 0.045, color: Colors.grey[600])),
                        Text("Try a different search term", style: GoogleFonts.poppins(fontSize: w * 0.035, color: Colors.grey[500])),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _searchField(double w, double h) {
    return Container(
